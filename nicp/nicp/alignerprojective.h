...
class AlignerProjective : public Aligner {
  public:
     ...
     */
    AlignerProjective(PointProjector* projector_, Linearizer* linearizer_, CorrespondenceFinderProjective* correspondenceFinder_) : Aligner(projector_, linearizer_, correspondenceFinder_) {}

    /**
     *  Destructor.
     */
    virtual ~AlignerProjective() {}
