...
int main(int argc, char **argv) {
  ...
  /* April Torc */
  mainWindow.spherical_projector_radioButton->setChecked(true);
  mainWindow.rows_spinBox->setValue(500);
  mainWindow.cols_spinBox->setValue(2500);
  mainWindow.min_distance_doubleSpinBox->setValue(2.0f);
  mainWindow.max_distance_doubleSpinBox->setValue(100.0f);
  mainWindow.min_image_radius_spinBox->setValue(3);
  mainWindow.max_image_radius_spinBox->setValue(100);
  mainWindow.min_points_spinBox->setValue(5);
  mainWindow.world_radius_doubleSpinBox->setValue(0.25f);
  mainWindow.curv_threshold_doubleSpinBox->setValue(1.0f);
  mainWindow.normal_angle_doubleSpinBox->setValue(0.75f);
  mainWindow.curv_flatness_doubleSpinBox->setValue(1.0f);
  mainWindow.point_distance_doubleSpinBox->setValue(1.5f);
  mainWindow.statsUpdate();
  mainWindow.correspondencesUpdate();
  mainWindow.alignerUpdate();
